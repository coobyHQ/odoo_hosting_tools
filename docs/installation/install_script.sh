...
# Author: Yenthe Van Ginneken, tweaked by Lucas Huber
#-------------------------------------------------------------------------------
# This script will install Odoo on your Ubuntu 16.04 server. It can install multiple Odoo instances
# in one Ubuntu because of the different xmlrpc_ports
# The script is using OCA version of Odoo https://github.com/OCA/OCB.git
#-------------------------------------------------------------------------------
# Make a new file:
...
OE_USER="odoo"
OE_HOME="/opt/$OE_USER"
OE_HOME_EXT="/opt/$OE_USER/${OE_USER}-server11"
...
sudo pip3 install python-ldap==3.0.0b4 ldap_filter
# sudo pip3 install python-ldap ldap_filter
